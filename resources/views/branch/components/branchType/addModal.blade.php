...
<div class="modal fade" id="branch-type-add-modal" tabindex="-1" aria-labelledby="addBusinessTypeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="{{ route('branch-types.store') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Branch Type</h5>
