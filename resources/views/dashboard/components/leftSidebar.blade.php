<div class="leftside-menu">
    ...
    <a href="index.html" class="logo logo-light">
        ...
        <span class="logo-sm">
            <img src="admin/images/logo-sm.png" alt="small logo">
        </span>
    </a>
    ...
    <a href="index.html" class="logo logo-dark">
        <span class="logo-lg">
            <img src="admin/images/logo-dark.png" alt="dark logo">
        </span>
        <span class="logo-sm">
            <img src="admin/images/logo-dark-sm.png" alt="small logo">
        </span>
    </a>
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <div class="leftbar-user">
            <a href="pages-profile.html">
                <img src="admin/images/users/avatar-1.jpg" alt="user-image" height="42"
        ...
        <ul class="side-nav">
            ...
            <div class="help-box text-white text-center">
                ...
                <img src="admin/images/svg/help-icon.svg" height="90" alt="Helper Icon Image" />
